...
_PORTAL_SEED_EXTRA: list[dict[str, Any]] = [
    ...
    {"key": "admin_role_user_desc",          "ru": "Может пользоваться личным кабинетом и видеть свои данные.", "en": "Can use the personal profile and view own data.", "ko": "개인 프로필을 사용하고 자신의 데이터를 볼 수 있습니다.", "kind": "ui", "module": "portal"},
    {"key": "admin_role_finance_manager_desc", "ru": "Управляет финансами: счетами, категориями, записями и настройками модуля Money.", "en": "Manages finances: accounts, categories, entries and Money module settings.", "ko": "재정을 관리합니다: 계좌, 카테고리, 거래 내역 및 Money 모듈 설정.", "kind": "ui", "module": "portal"},
