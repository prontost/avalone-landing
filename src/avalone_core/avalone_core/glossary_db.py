...
_PORTAL_SEED_EXTRA: list[dict[str, Any]] = [
    ...
    {"key": "shell_invite_hint",             "ru": "Отправьте ссылку другу. Ваш реферальный код уже встроен в ссылку.", "en": "Send the link to a friend. Your referral code is already included in the link.", "ko": "친구에게 링크를 복사하거나 공유하세요. 추천 코드가 링크에 포함되어 있습니다.", "kind": "ui", "module": "portal"},
